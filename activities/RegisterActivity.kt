...
import com.carlosvicente.gaugegrafico.databinding.ActivityRegisterBinding
        ...
        if (isValidForm(name, lastname, email, phone, password, confirmPassword)) {
            authProvider.register(email, password).addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    Toast.makeText(this@RegisterActivity, "registr Fallido ${it.exception.toString()}", Toast.LENGTH_LONG).show()
                    Log.d("FIREBASE", "Error: ${it.exception.toString()}")
                }
            }
